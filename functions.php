...
define( 'TTS_THEME_VERSION', '2021.01.06.01' );
...
function tts_enqueue_search_page_styles() {
    ...
    wp_enqueue_style( 'search', get_stylesheet_directory_uri() . '/css/search.css', array(), TTS_THEME_VERSION );
...
function tts_enqueue_front_page_styles() {
    if ( is_front_page() ) {
        wp_enqueue_style( 'home-styling', get_stylesheet_directory_uri() . '/css/home.css', array(), TTS_THEME_VERSION );
    }
}
...
function tts_eneuuee_scripts() {
    wp_enqueue_script( 'tts-custom-js', get_stylesheet_directory_uri() . '/js/tts-custom.js', array( 'jquery' ), TTS_THEME_VERSION, true );
    wp_enqueue_script( 'tts-live-search', get_stylesheet_directory_uri() . '/js/tts-live-search.js', array( 'jquery' ), TTS_THEME_VERSION, true );
    $ssl_scheme     = is_ssl() ? 'https' : 'http';
    $front_end_data = array(
        'ajaxUrl' => admin_url( 'admin-ajax.php', $ssl_scheme ),
    );
    wp_localize_script( 'tts-live-search', 'TTSThemeData', $front_end_data );
...
add_action( 'wp_ajax_tts_live_search', 'tts_live_search' );
add_action( 'wp_ajax_nopriv_tts_live_search', 'tts_live_search' );