...
//  Event Table
//
class AdministrateWidgetEventTable1 extends AdministrateEventWidget2 {
    public $wurl;
    public $wpath;
    public function __construct($service) {
		parent::__construct($service, 'event_table_1');
		$this->wpath = untrailingslashit(get_stylesheet_directory()) . '/courses/adminstrate/shortcodes/event_table_1/';
		$this->wurl = untrailingslashit(get_stylesheet_directory_uri()) . '/courses/adminstrate/shortcodes/event_table_1/';
	...
	public function run($widget_params = array()) {
		...
		$this->params['group_size'] = 0;
                $this->params['num_saved_months'] = 6;
                ob_start();
                    extract($this->params);
                    include($this->wpath . 'views/event_table_1.php');
